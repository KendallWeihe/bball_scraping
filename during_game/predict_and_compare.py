...
# ARGV:
    # stats data file name -- also the same as the halftime spread, but a different directory

prediction_game = np.genfromtxt("./ncaa_data/" + sys.argv[1], delimiter=",")
...
with tf.Session() as sess:
    ...
    for step in range(700):
        ...
        if step > 250:
            ...
            actual_pred = slope * np.mean(np.array(single_game_pred)) + intercept
