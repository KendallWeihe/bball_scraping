...
for k in range(500):
    ...
    train_X = data[0:data.shape[0]-n_predictions,0:8]
    train_Y = data[0:data.shape[0]-n_predictions,8] - data[0:data.shape[0]-n_predictions,9]

    pred_X = data[data.shape[0]-n_predictions:data.shape[0],0:8]
    pred_Y = data[data.shape[0]-n_predictions:data.shape[0],8] - data[data.shape[0]-n_predictions:data.shape[0],9]
